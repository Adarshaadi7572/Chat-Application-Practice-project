...
const Sidebar = () => {
  ...
  return(
    <div className='bg-[#f4f5f8] grow-[0.2] flex flex-col sidebar-container'>
        <div className={` rounded-md py-[5px] px-[5px] m-[10px] flex items-center justify-between ${lightTheme ? `bg-white`: `bg-[#2d3941]`} sb-header` }>
          <div>
          <IconButton  onClick={() => {
        ...
        <div className={`bg-white rounded-md py-[5px] px-[5px] m-[10px] flex items-center gap-1 ${lightTheme ? "":"bg-[#2d3941]"} sb-search`}>
          <SearchIcon className={lightTheme ? '' : 'text-white'}/>
          <input placeholder='Search' className={`border-none outline-none ${lightTheme ? "":"bg-[#2d3941] text-white"}`}/>
        </div>
        <div className={`bg-white rounded-md py-[5px] px-[5px] m-[10px] flex flex-col grow-[1] ${lightTheme ? `bg-white`: `bg-[#2d3941]`} sb-conversation` }>
